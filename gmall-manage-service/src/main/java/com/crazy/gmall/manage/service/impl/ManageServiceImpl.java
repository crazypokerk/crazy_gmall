package com.crazy.gmall.manage.service.impl;

import com.alibaba.dubbo.config.annotation.Service;
import com.alibaba.fastjson.JSON;
import com.crazy.gmall.bean.*;
import com.crazy.gmall.config.RedisUtil;
import com.crazy.gmall.manage.constant.ManageConst;
import com.crazy.gmall.manage.mapper.*;
...
//    return baseAttrInfoMapper.select(baseAttrInfo);
  ...
  public SkuInfo getSkuInfo(String skuId) {
    ...
    try {
      ...
      //redis如何存？key = sku:skuId:info  sku:info,作为一个常量
      // 定义key
  ...
  public List<SpuSaleAttr> selectSpuSaleAttrListCheckBySku(SkuInfo skuInfo) {
    return spuSaleAttrMapper.selectSpuSaleAttrListCheakSku(Long.parseLong(skuInfo.getId()), Long.parseLong(skuInfo.getSpuId()));
  }
